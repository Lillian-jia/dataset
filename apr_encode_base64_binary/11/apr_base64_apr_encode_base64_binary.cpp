...
int main(int argc, char **argv) {
    ...
    const unsigned char * val_1 = (const unsigned char * )malloc(SIZE);
    int val_2 = 0;
    int val_3 = 0;
    ...
    /* Call API */
    int ret_0 = apr_encode_base64_binary((char *)val_0, (const unsigned char *)val_1, (int)val_2, (int)val_3, (unsigned long *)val_4);
